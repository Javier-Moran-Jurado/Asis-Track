package co.edu.uceva.microserviciousuario.delibery.exception;

import co.edu.uceva.microserviciousuario.domain.exceptions.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handlerPaginaSinUsuarios(PaginaSinUsuariosException ex) {
    ...
    public ResponseEntity<Map<String, Object>> handleNoHayUsuarios(NoHayUsuariosException ex) {
        ...
        response.put(USUARIOS, null); // para que sea siempre el mismo campo
