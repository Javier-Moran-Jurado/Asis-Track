...
import co.edu.uceva.microservicioplanilla.domain.service.PublicKeyResponseDTO;
...
public class SecurityIntegrationService {
    ...
    @Cacheable(value = "planilla-securityKeys", key = "'active_private'")
    ...
    @Cacheable(value = "planilla-securityKeys", key = "'active_public'")
    ...
    @Cacheable(value = "planilla-securityKeys", key = "'private_' + #id")
