...
import co.edu.uceva.microservicioplanilla.delibery.rest.dto.EntradaRequest;
import co.edu.uceva.microservicioplanilla.delibery.rest.dto.JustificarRequest;
import co.edu.uceva.microservicioplanilla.domain.model.Asistencia;
import co.edu.uceva.microservicioplanilla.domain.service.IAsistenciaService;
...
@RestController
@RequestMapping("/api/v1/planilla-service/asistencias")
...
public class AsistenciaRestController {
    ...
    public ResponseEntity<Asistencia> justificarAusencia(
        ...
        if (justificacion != null) {
            ...
            if (datosAdicionales != null) {
                datosAdicionales = justificacionJson.substring(0, justificacionJson.length() - 1) + "," + datosAdicionales.substring(1);
            } else {
    ...
    public ResponseEntity<Asistencia> actualizarEstado(@PathVariable Long id, @RequestParam String estado) {
